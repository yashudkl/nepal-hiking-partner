...
import mountainsImg from "../assets/hero.png";
const stats = [
...
const features = [
  {
    ...
    desc: 'From Everest Base Camp to Annapurna Circuit — fully guided, all seasons.',
  },
  {
    icon: '🧘',
    title: 'Mindful Retreats',
    desc: 'Yoga and meditation retreats set against the world\'s most dramatic landscapes.',
  },
  {
    icon: '🚵',
    title: 'Mountain Biking',
    desc: 'Technical trails, downhill runs, and multi-day biking expeditions across Nepal.',
  },
  {
    icon: '🌿',
    title: 'Eco Tours',
    desc: 'Sustainable, low-impact journeys through Nepal\'s biodiversity hotspots.',
  },
]
...
/>
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <button className="btn-primary" onClick={() => navigate('/trek')}>Explore Treks</button>
